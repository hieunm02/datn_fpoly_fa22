...
<div class="container position-relative pb-5">
    ...
    <div class="col-lg-7 col-md-7 m-auto p-3" style="border:1px solid #ffcc29">
        ...
        <div class="w-100">
            ...
            <h6 class="text-center pb-5">{{ $order->created_at }}</h6>
            <div class="p-3 col-lg-10 m-auto">
                <div class="d-flex">
                    <div class="col-lg-6"><b>Mã hóa đơn:</b> {{ $order->code }}</div>
                    @if($order->status_id == 1)
                    <div class="col-lg-6"><b>Trạng thái: </b>Chờ xác nhận</div>
                    @elseif($order->status_id == 2)
                    <div class="col-lg-6"><b>Trạng thái: </b>Đang xử lý</div>
                    @elseif($order->status_id == 2)
                    <div class="col-lg-6"><b>Trạng thái: </b>Đang giao</div>
                    @elseif($order->status_id == 2)
                    <div class="col-lg-6"><b>Trạng thái: </b>Đã giao</div>
                    @else
                    <div class="col-lg-6"><b>Trạng thái: </b>Đã hủy</div>
                    @endif
                </div>
                <div class="d-flex">
                    <div class="col-lg-6"><b>Email: </b> {{ $order->email }}</div>
                    <div class="col-lg-6"><b>Địa chỉ: </b> {{ $order->address }}</div>
                </div>
            </div>
        </div>
        <div class="">
