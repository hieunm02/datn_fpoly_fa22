                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control is-invalid" name="price" id="" placeholder="Product Price" value="{{ old('price') }}">
                                        <div class="invalid-feedback">{{ $errors->first('price') }}</div>
                                        @else
                                        <input type="text" class="form-control money" name="price" id="" placeholder="Product Price" value="{{ old('price') }}">
                                        @endif
                                    </div>
                                    <div class="form-group">
                                        <label class="font-weight-semibold" for="productPrice">Giá Sales</label>
                                        @if (session('price_sales'))
                                        <input type="text" class="form-control is-invalid" name="price_sales" id="" placeholder="Product Price Sales" value="{{ old('price_sales') }}">
                                        <div class="invalid-feedback">{{ session('price_sales') }}</div>
                                        @else
                                        <input type="text" class="form-control money" name="price_sales" id="" placeholder="Product Price Sales" value="{{ old('price_sales') }}">
                                        @endif
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group mt-3">
                                        ...
                                        @else
                                        <input type="text" class="form-control" name="quantity" id="" placeholder="Quantity" value="{{ old('quantity') }}">
                                        @endif
                                    </div>
                                    <div class="form-group">
