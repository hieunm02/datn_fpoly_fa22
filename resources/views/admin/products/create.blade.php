                        ...
                        <div class="avatar avatar-image rounded" style="height: 60px; width:60px">
                            @if ($errors->first('thumb'))
                                <img name="avatar" data-toggle="tooltip" data-placement="top" title="Tải lên Ảnh Sản Phẩm"
                                    style="cursor: pointer" id="avatar"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    @if ($errors->first('price'))
                                        <input type="text" class="form-control is-invalid" name="price" id=""
                                            placeholder="Product Price" value="{{ old('price') }}">
                                        <div class="invalid-feedback">{{ $errors->first('price') }}</div>
                                    @else
                                        <input type="text" class="form-control" name="price" id=""
                                            placeholder="Product Name" value="{{ old('price') }}">
                                    @endif
                                </div>
                                <div class="form-group">
                                    ...
                                    @else
                                        <input type="text" class="form-control" name="price_sales" id=""
                                            placeholder="Product Name" value="{{ old('price_sales') }}">
                                    @endif
                                </div>
                                <div class="form-group">
