                    ...
                    <div class="col-md-6">
                        <div class="osahan-cart-item rounded rounded shadow-sm overflow-hidden bg-white sticky_sidebar">
                            <div class="border-bottom osahan-cart-item-profile bg-white p-3">
                                <div class="d-flex flex-column">
                                    <h6 class="mb-3 font-weight-bold display-5 py-3 rounded text-center btn-primary">Đơn
                                        hàng
                                        của bạn</h6>
                                </div>
                            </div>
                                        ...
                                        <div id="cart_item{{ $cart->id }}"
                                            ...
                                            <div class="media align-items-center">
                                                <div class="media-body d-flex">
                                                    <input type="checkbox" hidden checked name="product_id[]"
                                                        class="mr-1" value="{{ $cart->product_id }}">
                            ...
                            <div class="bg-white p-3 clearfix border-bottom">
                                ...
                                <p class="mb-1">Shipping<span class="text-info ml-1"><i
                                        ...
                                        class="float-right text-dark">Free</span>
                                </p>
                            ...
                            <div class="p-3">
                                <button type="button" class="btn btn-success btn-block btn-lg" id="datHang">Đặt hàng<i
