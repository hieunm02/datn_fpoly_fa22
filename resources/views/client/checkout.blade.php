            ...
            <form action="" class="row" method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            ...
                                            <div class="input-group">
                                                <input placeholder="Họ tên" name="name" type="text" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="osahan-cart-item rounded rounded shadow-sm overflow-hidden bg-white sticky_sidebar">
                        ...
                        <div class="bg-white border-bottom py-2">
                            @foreach ($carts as $cart)
                                <div hidden>
                                    ...
                                    <input type="text" name="product_id[]" value="{{ $cart->id }}">
                                </div>
                                <div
                                    ...
                                    <div class="d-flex align-items-center">
                                        <span class="count-number float-right">
                                                <input class="count-number-input pr-1" width="50px" type="number" name="quantity"
                        ...
                        <div class="p-3">
                            <a class="btn btn-success btn-block btn-lg" href="successful.html">Đặt hàng<i
