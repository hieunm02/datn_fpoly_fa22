                        ...
                        <div class="flex-column">
                            ...
                            <form>
                                <div class="col-md-12 p-0 row m-0">
                                    <div class="form-group col-md-6 p-0 pr-1">
                                        <label for="exampleFormControlInput1" class="small font-weight-bold">Tên của
                                            bạn</label>
                                        <input type="text" class="form-control <?php echo $errors->first('name') ? 'is-invalid' : ''; ?>"
                                            id="exampleFormControlInput1" value="{{ old('name') }}" name="name"
                                    ...
                                    <div class="form-group col-md-6 p-0 pl-1">
                                        ...
                                        <input type="number" class="form-control  <?php echo $errors->first('phone') ? 'is-invalid' : ''; ?>"
                                            id="exampleFormControlInput3" value="{{ old('phone') }}" name="phone"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control  <?php echo $errors->first('email') ? 'is-invalid' : ''; ?>"
                                        id="exampleFormControlInput2" value="{{ old('email') }}" name="email"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control  <?php echo $errors->first('content') ? 'is-invalid' : ''; ?>" id="exampleFormControlTextarea1" value="{{ old('content') }}"
                                        name="content" placeholder="Nội dung ..." rows="5">{{ old('content') }}</textarea>
