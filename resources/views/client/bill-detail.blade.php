...
<div class="container position-relative pb-5">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td colspan="1" class="text-warning">{{$voucher != null ? $voucher->code : 'Không có'}} {{$voucher != null ? ($voucher->discount . '%') : ''}}</td>
                    </tr>
                    <tr>
    ...
    <div class="mt-3 text-center">
        <a href="{{ route('bills') }}" class="btn btn-success ml-3">Quay lại</a>
    </div>
</div>
@endsection