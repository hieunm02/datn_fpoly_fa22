...
@section('content')
                ...
                <div class="d-flex justify-content-between mb-4 row">
                    ...
                    <div class="d-flex">
                        <div class="btn-create-order-group mx-2" id="btn-create-order-group">
                            <div class="input-group">
                                <input type="text" id="search"
                                    ...
                                    id="inlineFormInputGroup" placeholder="Tìm kiếm ở đây...">
                        ...
                        <a href="#" data-toggle="modal" data-target="#filters" class="ml-auto btn btn-primary mx-1">Bộ
                            lọc</a>
                        @if (Auth::user())
                            <a href="#" data-toggle="modal" data-target="#order_group" id="btn-order_group"
                                class="ml-auto btn btn-primary mx-1">Đặt nhóm</a>
                        @else()
                            <a href="#" data-toggle="modal" data-target="#check_login" id="btn-check_login"
                                class="ml-auto btn btn-primary mx-1">Đặt nhóm</a>
                        @endif
                    </div>
                </div>
    ...
    <div class="modal fade" id="filters" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
                        ...
                        <div class="filter">
                            ...
                            <form action="/list-products" method="get">
                                <div class="custom-control border-bottom px-0  custom-radio">
                                    <input type="radio" id="customRadio3" value="0" name="price_low_high"
                                        class="custom-control-input">
                                    <label class="custom-control-label py-3 w-100 px-3" for="customRadio3">Từ thấp đến
                                        cao</label>
                                </div>
                                <div class="custom-control border-bottom px-0  custom-radio">
                                    <input type="radio" id="customRadio4" value="1" name="price_low_high"
                                        class="custom-control-input">
                                ...
                                <div class="px-3 pt-3">
                                    <div class="form-row">
                                        <div class="form-group col-6">
                                            <label>Từ</label>
                                            <input class="form-control" name="price_from" placeholder="Từ"
                                                type="number">
                                        </div>
                                        <div class="form-group text-right col-6">
                                            <label>Đến</label>
                                            <input class="form-control" name="price_to" placeholder="Đến"
                                                type="number">
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="modal fade" id="order_group" style="margin-top: 8%" tabindex="-1" role="dialog"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body p-0 mt-3">
                    <div class="title text-center">
                        <img alt="#" src="{{ asset('assets/images/logo/order-group.png') }}"
                            class="img-fluid item-img" width="25%">
                    ...
                    <div class="modal-button text-center my-3">
                        ...
                        <input type="button" id="join_group" onclick="joinGroup()" class="btn btn-light"
                            value="Vào nhóm">
                    </div>
                </div>
                <div class="modal-footer p-0 border-0">
                    <div class="col-6 m-0 p-0">
                        <input type="submit" class="btn btn-primary btn-lg btn-block" onclick="orderGroup()"
                            value="Tiếp tục đặt nhóm" data-dismiss="modal">
                    </div>
                </div>
                </form>
            </div>
    ...
    {{-- check-login  --}}
    <div class="modal fade" id="check_login" tabindex="-1" style="margin-top: 8%" role="dialog"
        aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                                ...
                                <form class="mt-5 mb-4" action="/login" method="POST">
                                    ...
                                    <div class="py-2">
                                        <a href="/auth/google/redirect">
                                            <button type="button" class="btn btn-lg btn-primary btn-block"><i
                                                    class="feather-google"></i> Connect with Google</button>
                                        </a>
                                    </div>
                                </form>
                            </div>
